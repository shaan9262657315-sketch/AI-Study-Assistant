...
import { getPDFLibrary, uploadPDF } from "../services/api";
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
          ...
          <form onSubmit={handleUpload}>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-indigo-400 transition">
              ...
              <input
                ...
                className="block w-full max-w-md mx-auto text-sm text-gray-600
        ...
        <div className="bg-white rounded-2xl shadow p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={loadPDFs}
              className="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-700 font-semibold"
            >
              🔄 Refresh
            </button>
